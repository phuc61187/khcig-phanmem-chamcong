...
namespace ChamCong_v04.UI.Admin {
	public partial class frm_Setting : Form {
		...
		private void btnSave_Click(object sender, EventArgs e) {
			...
			DAO.UpdSetting((int)numPC30.Tag, val30.ToString());
			var val50 = (int)numPC50.Value;
			DAO.UpdSetting((int)numPC50.Tag, val50.ToString());
			var valPCTCC3 = (int)numPCTCC3.Value;
			DAO.UpdSetting((int)numPCTCC3.Tag, valPCTCC3.ToString());
			var val100 = (int)numPC100.Value;
			DAO.UpdSetting((int)numPC100.Tag, val100.ToString());
			var val160 = (int)numPC160.Value;
			DAO.UpdSetting((int)numPC160.Tag, val160.ToString());
			var val200 = (int)numPC200.Value;
			DAO.UpdSetting((int)numPC200.Tag, val200.ToString());
			var val290 = (int)numPC290.Value;
			DAO.UpdSetting((int)numPC290.Tag, val290.ToString());
			var valTGLamDemToiThieu = dateTimePicker1.Value.TimeOfDay;
			DAO.UpdSetting((int)dateTimePicker1.Tag, valTGLamDemToiThieu.ToString(@"hh\:mm\:") + "00");
			var valChoPhepTre = (int)numPhutTre.Value;
			DAO.UpdSetting((int)numPhutTre.Tag, valChoPhepTre.ToString());
			var valChoPhepSom = (int)numPhutSom.Value;
			DAO.UpdSetting((int)numPhutSom.Tag, valChoPhepSom.ToString());
			var valLamThemAfterOT = (int)numPhutAfterOT.Value;
			DAO.UpdSetting((int)numPhutAfterOT.Tag, valLamThemAfterOT.ToString());
