...
namespace ChamCong_v04.UI.QLNV {
	public partial class frmCapNhatCongNhat : Form {
		...
		private void dtpThang_ValueChanged(object sender, EventArgs e) {
			...
			DataTable tableThangketcong = DAO.KiemtraTinhtrangKetcongThang(m_thang, (int)m_currRowNV["UserEnrollNumber"]);
			DataTable tableKhoangThoigianCongnhat = DAO.LayKhoangThoigianCongnhat(m_thang, (int)m_currRowNV["UserEnrollNumber"]);
		...
		VALUES
				...
				DAO.GhiNhatKyThaotac("Lưu ngày làm việc công nhật",
