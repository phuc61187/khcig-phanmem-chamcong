...
//			checkedComboBoxEdit1.Properties.Items.Clear();
		...
		private void ChamCong(DataTable tableArrMaCC, DateTime ngayDauThang) {
			/* 1. kiểm tra tình trạng kết lương, đã kết lương thì đọc từ csdl lên, chưa kết thì xem theo ngày*/
			if (XL.KiemtraKetluongThang45(ngayDauThang)) {
				XL.XemCongThangDaKetLuong45(tableArrMaCC, ngayDauThang);
			}
			else {
				XL.XemCongThangChuaKetLuong45(tableArrMaCC, ngayDauThang);
			}
		}
