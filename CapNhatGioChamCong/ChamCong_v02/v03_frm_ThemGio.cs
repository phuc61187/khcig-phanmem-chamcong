...
namespace ChamCong_v02 {
    public partial class v03_frm_ThemGio : Form {
        ...
        private void frm_ThemGio2_Load(object sender, EventArgs e) {
            ...
            List<cShift> dataCa_Raa = new List<cShift>(ThamSo.DSCa);
            dataCa_Raa.Insert(0, new cShift() { ShiftID = 0, ShiftCode = "Tuỳ chỉnh", LoaiCa = 1 });
        ...
        void dtpGio_Raa_ValueChanged(object sender, EventArgs e) {
            ...
            cShift ca = cbCa_Raa.SelectedItem as cShift; // lay ca duoc chon và kiem tra xem gio Raa có nằm trong khoảng hiểu ca ko.
        ...
        private void cbCa_Vao_SelectionChangeCommitted(object sender, EventArgs e) {
            ...
            dtpGio_Vao.ValueChanged -= dtpGio_Vao_ValueChanged;
            DateTime x = DateTime.Today.Add(ca.OnnDutyTS);
        ...
        private void btnThemGio_Vao_Click(object sender, EventArgs e) {
            ...
            for (int i = 0; i < DSNgayCongChked.Length; i++) {
                ...
                bool kq = DAL.ThemGioChoNV(iUserEnrollNumber, ngay, true, 21, ThamSo.currUserID, lydo_vao, ghichu_vao);
                if (kq == false) {
        ...
        private void btnThemGio_Raa_Click(object sender, EventArgs e) {
            ...
            for (int i = 0; i < DSNgayCongChked.Length; i++) {
                ...
                bool kq = DAL.ThemGioChoNV(iUserEnrollNumber, ngay, false, 22, ThamSo.currUserID, lydo_Raa, ghichu_Raa);
                if (kq == false) {
                    name = row["UserFullName"].ToString();
                    flag = false;
                    break;
