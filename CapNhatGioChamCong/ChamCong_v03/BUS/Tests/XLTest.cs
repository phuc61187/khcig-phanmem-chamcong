...
namespace ChamCong_v03.BUSTest
{
    ...
    public class XLTest
    {
        ...
        /// <summary>
        /// Thuoc Ngay Cong Method Test
        /// Documentation   :  
        /// Method Signature:  DateTime ThuocNgayCong(DateTime chkinn)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void ThuocNgayCongTest()
        {
            DateTime methodStartTime = DateTime.Now;
            DateTime expected = new DateTime(1969,7,21);
            
            //Parameters
            DateTime chkinn = new DateTime(1969,7,21);

            DateTime results = XL.ThuocNgayCong(chkinn);
            Assert.AreEqual(expected, results, "ChamCong_v03.BUS.XL.ThuocNgayCong method test failed");

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.ThuocNgayCong Time Elapsed: {0}", methodDuration));
        }
        ...
        public void VaoTest()
        {
            ...
            //Parameters
            DateTime timeinn = new DateTime(1969,7,21);
            DateTime onnduty = new DateTime(1969,7,21);
            DateTime chopheptre = new DateTime(1969,7,21);
            ...
            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.Vao Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Raa Method Test
        /// Documentation   :  
        /// Method Signature:  void Raa(DateTime timeout, DateTime offduty, DateTime chophepsom, out DateTime raalam_ChuaOT, out TimeSpan som)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void RaaTest()
        {
            ...
            DateTime chophepsom = new DateTime(1969,7,21);
            DateTime raalam_ChuaOT = new DateTime(1969,7,21);
            TimeSpan som = new TimeSpan();

            XL.Raa(timeout, offduty, chophepsom, out raalam_ChuaOT, out som);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.Raa Time Elapsed: {0}", methodDuration));
        }
        ...
        /// Documentation   :  
        /// Method Signature:  void TGLamTinhCong(DateTime vaolam, DateTime raalam, TimeSpan LunchMin, out TimeSpan TGLamTinhCong)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void TGLamTinhCongTest()
        {
            ...
            XL.TGLamTinhCong(vaolam, raalam, LunchMin, out TGLamTinhCong);
        ...
        public void LamDemTest()
        {
            ...
            DateTime VaoLam = new DateTime(1969,7,21);
            DateTime RaaLam = new DateTime(1969,7,21);
            DateTime _21h45 = new DateTime(1969,7,21);
            DateTime _05h45 = new DateTime(1969,7,21);
            ...
            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.LamDem Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Tinh Piece Dem PercentC Method Test
        /// Documentation   :  
        /// Method Signature:  void TinhPCDem_PCTC(TimeSpan SoGioTinhCong, TimeSpan SoGioLamDemmm, bool TinhPC50, bool QuaDem, TimeSpan SoGioLamThem, out TimeSpan tgTinh130, out TimeSpan tgTinh150, out TimeSpan tgTinhTCC3, out double PhuCap30, out double PhuCapTC, out double PhuCapTCC3, out double TongPhuCap)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void TinhPCDem_PCTCTest()
        {
            DateTime methodStartTime = DateTime.Now;
            
            //Parameters
            TimeSpan SoGioTinhCong = new TimeSpan();
            TimeSpan SoGioLamDemmm = new TimeSpan();
            const bool TinhPC50 = true;
            const bool QuaDem = true;
            TimeSpan SoGioLamThem = new TimeSpan();
            TimeSpan tgTinh130 = new TimeSpan();
            TimeSpan tgTinh150 = new TimeSpan();
            TimeSpan tgTinhTCC3 = new TimeSpan();
            double PhuCap30 = 3.14159265D;
            double PhuCapTC = 3.14159265D;
            double PhuCapTCC3 = 3.14159265D;
            double TongPhuCap = 3.14159265D;

            XL.TinhPCDem_PCTC(SoGioTinhCong, SoGioLamDemmm, TinhPC50, QuaDem, SoGioLamThem, out tgTinh130, out tgTinh150, out tgTinhTCC3, out PhuCap30, out PhuCapTC, out PhuCapTCC3, out TongPhuCap);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.TinhPCDem_PCTC Time Elapsed: {0}", methodDuration));
        }
        ...
        public void TinhPCDBTest()
        {
            ...
            const int loaiPC = 123;
            const float pcngay = 2.99999F;
            const float pcdem = 2.99999F;
        ...
        /// <summary>
        /// Tinh Cong Theo Ca Method Test
        /// Documentation   :  
        /// Method Signature:  void TinhCongTheoCa(cChkInOut CIO, cCaAbs ca)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void TinhCongTheoCaTest()
        {
            DateTime methodStartTime = DateTime.Now;
            
            //Parameters
            cChkInOut CIO = new cChkInOut();
            cCaAbs ca = new cCaAbs();

            XL.TinhCongTheoCa(CIO, ca);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.TinhCongTheoCa Time Elapsed: {0}", methodDuration));
        }
        ...
        public void ThemGioChoNVTest()
        {
            ...
            const int pUserID = 123;
            const string pLydo = "test";
            const string pGhichu = "test";

            XL.ThemGioChoNV(check, nv, pUserID, pLydo, pGhichu);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.ThemGioChoNV Time Elapsed: {0}", methodDuration));
        }
        ...
        [Test]
        [Ignore("Please Implement")]
        public void ThemGioChoNVQLTest()
        {
            DateTime methodStartTime = DateTime.Now;
            ...
            XL.ThemGioChoNVQL(check, nv, pUserID, pLydo, pGhichu);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.ThemGioChoNVQL Time Elapsed: {0}", methodDuration));
        }
        ...
        public void XoaGioChoNVTest()
        {
            ...
            const int currUserID = 123;
            const string lydo = "test";
            const string ghichu = "test";

            bool results = XL.XoaGioChoNV(check, nhanvien, currUserID, lydo, ghichu);
            Assert.AreEqual(expected, results, "ChamCong_v03.BUS.XL.XoaGioChoNV method test failed");

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.XoaGioChoNV Time Elapsed: {0}", methodDuration));
        }
        ...
        [Test]
        [Ignore("Please Implement")]
        public void SuaGioChoNVTest()
        {
            DateTime methodStartTime = DateTime.Now;
            
            //Parameters
            cChk checkold = new cChk();
            cChk checknew = new cChk();
            cUserInfo nhanvien = new cUserInfo();
            const int currUserID = 123;
            const string lydo = "test";
            const string ghichu = "test";

            XL.SuaGioChoNV(checkold, checknew, nhanvien, currUserID, lydo, ghichu);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.SuaGioChoNV Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Xac Nhan Ko Tach Ca Method Test
        /// Documentation   :  
        /// Method Signature:  void XacNhanKoTachCa(cUserInfo nhanvien, cChkInOut CIO, cCaAbs caMoi, int sophutlamthem, bool choPhepTinhPC50)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void XacNhanKoTachCaTest()
        {
            DateTime methodStartTime = DateTime.Now;
            ...
            cUserInfo nhanvien = new cUserInfo();
            cChkInOut CIO = new cChkInOut();
            cCaAbs caMoi = new cCaAbs();
            const int sophutlamthem = 123;
            const bool choPhepTinhPC50 = true;

            XL.XacNhanKoTachCa(nhanvien, CIO, caMoi, sophutlamthem, choPhepTinhPC50);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.XacNhanKoTachCa Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Xac Nhan Ko Tach Ca Cho QL Method Test
        /// Documentation   :  
        /// Method Signature:  void XacNhanKoTachCaChoQL(cUserInfo nhanvien, cChkInOut CIO, cCaAbs caMoi, int sophutlamthem, bool choPhepTinhPC50)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void XacNhanKoTachCaChoQLTest()
        {
            DateTime methodStartTime = DateTime.Now;
            ...
            XL.XacNhanKoTachCaChoQL(nhanvien, CIO, caMoi, sophutlamthem, choPhepTinhPC50);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.XacNhanKoTachCaChoQL Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Xac Nhan Co Tach Ca Method Test
        /// Documentation   :  
        /// Method Signature:  void XacNhanCoTachCa(cUserInfo nhanvien, cChkInOut CIO, cCaAbs caMoi, int sophutlamthem, bool choPhepTinhPC50)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void XacNhanCoTachCaTest()
        {
            DateTime methodStartTime = DateTime.Now;
            ...
            XL.XacNhanCoTachCa(nhanvien, CIO, caMoi, sophutlamthem, choPhepTinhPC50);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.XacNhanCoTachCa Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Xac Nhan Co Tach Ca Cho QL Method Test
        /// Documentation   :  
        /// Method Signature:  void XacNhanCoTachCaChoQL(cUserInfo nhanvien, cChkInOut CIO, cCaAbs caMoi, int sophutlamthem, bool choPhepTinhPC50)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void XacNhanCoTachCaChoQLTest()
        {
            DateTime methodStartTime = DateTime.Now;
            ...
            XL.XacNhanCoTachCaChoQL(nhanvien, CIO, caMoi, sophutlamthem, choPhepTinhPC50);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.XacNhanCoTachCaChoQL Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Xac Nhan Lai Ko Tach Ca Method Test
        /// Documentation   :  
        /// Method Signature:  void XacNhanLaiKoTachCa(cUserInfo nhanvien, ref cChkInOut CIO, cCaAbs caMoi, int sophutlamthem, bool choPhepTinhPC50)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        public void XacNhanLaiKoTachCaTest()
        {
            DateTime methodStartTime = DateTime.Now;
            ...
            XL.XacNhanLaiKoTachCa(nhanvien, ref CIO, caMoi, sophutlamthem, choPhepTinhPC50);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.XacNhanLaiKoTachCa Time Elapsed: {0}", methodDuration));
        }
        ...
        [Test]
        [Ignore("Please Implement")]
        public void FormatCellsTest()
        {
            DateTime methodStartTime = DateTime.Now;
            
            //Parameters
            ExcelRange cell = new ExcelRange();
            ...
            const int size = 123;
            = 0 = new =();
            const bool VeBorder = true;
            = true = new =();
            ExcelBorderStyle viendamnhat = new ExcelBorderStyle();
            = ExcelBorderStyle.Thin = new =();
            ExcelHorizontalAlignment hAlign = new ExcelHorizontalAlignment();
            = ExcelHorizontalAlignment.Center = new =();
            ExcelVerticalAlignment vAlign = new ExcelVerticalAlignment();
            = ExcelVerticalAlignment.Center = new =();
            const string numberFormat = "test";
            = null = new =();
            const int textRotation = 123;
            = 0 = new =();

            XL.FormatCells(cell, value, wraptext, false, merge, false, bold, false, italic, false, size, 0, VeBorder, true, viendamnhat, ExcelBorderStyle.Thin, hAlign, ExcelHorizontalAlignment.Center, vAlign, ExcelVerticalAlignment.Center, numberFormat, null, textRotation, 0);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.FormatCells Time Elapsed: {0}", methodDuration));
        }
        ...
        [Test]
        [Ignore("Please Implement")]
        public void FCongTest()
        {
            DateTime methodStartTime = DateTime.Now;
            
            //Parameters
            ExcelRange cell1 = new ExcelRange();
            ExcelRange cell2 = new ExcelRange();
            ExcelRange cell3 = new ExcelRange();
            ExcelRange cell123 = new ExcelRange();
            object value1 = new object();
            object value2 = new object();
            object value3 = new object();
            ExcelBorderStyle viendamnhat = new ExcelBorderStyle();
            = ExcelBorderStyle.Thick = new =();
            ExcelVerticalAlignment vAlign = new ExcelVerticalAlignment();
            = ExcelVerticalAlignment.Center = new =();
            ExcelHorizontalAlignment hAlign = new ExcelHorizontalAlignment();
            = ExcelHorizontalAlignment.Right = new =();
            const string numberFormat = "test";

            XL.FCong(cell1, cell2, cell3, cell123, value1, value2, value3, viendamnhat, ExcelBorderStyle.Thick, vAlign, ExcelVerticalAlignment.Center, hAlign, ExcelHorizontalAlignment.Right, numberFormat);

            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.FCong Time Elapsed: {0}", methodDuration));
        }

        /// <summary>
        /// Kiemtra Gio Raa Nho Hon Gio Vao Method Test
        /// Documentation   :  
        /// Method Signature:  void Kiemtra_GioRaaNhoHonGioVao(DateTime giovao1, List&lt;cChkInOut&gt; dsVaoRa, ref int kq, ref List&lt;cChkInOut&gt; gioAnhHuong, ref string loai)
        /// </summary>
        [Test]
        [Ignore("Please Implement")]
        ...
        public void TinhPCDB1Test()
        {
            ...
            TimeSpan methodDuration = DateTime.Now.Subtract(methodStartTime);
            Console.WriteLine(String.Format("ChamCong_v03.BUS.XL.TinhPCDB1 Time Elapsed: {0}", methodDuration));
        }
