...
{
	partial class frm_311_ThongTinSuaGioHangLoat {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			// 
			// frm_311_ThongTinSuaGioHangLoat
			// 
			...
			this.Name = "frm_311_ThongTinSuaGioHangLoat";
