...
namespace ChamCong_v03 {
	public partial class frm_61_Setting : Form {
		...
		private void btnSave_Click(object sender, EventArgs e) {
			...
			DAL.UpdateSetting((int)numPC30.Tag, val30.ToString());
			var val50 = (int)numPC50.Value;
			DAL.UpdateSetting((int)numPC50.Tag, val50.ToString());
			var valPCTCC3 = (int)numPCTCC3.Value;
			DAL.UpdateSetting((int)numPCTCC3.Tag, valPCTCC3.ToString());
			var val100 = (int)numPC100.Value;
			DAL.UpdateSetting((int)numPC100.Tag, val100.ToString());
			var val160 = (int)numPC160.Value;
			DAL.UpdateSetting((int)numPC160.Tag, val160.ToString());
			var val200 = (int)numPC200.Value;
			DAL.UpdateSetting((int)numPC200.Tag, val200.ToString());
			var val290 = (int)numPC290.Value;
			DAL.UpdateSetting((int)numPC290.Tag, val290.ToString());
			var valTGLamDemToiThieu = dateTimePicker1.Value.TimeOfDay;
			DAL.UpdateSetting((int)dateTimePicker1.Tag, valTGLamDemToiThieu.ToString(@"hh\:mm\:") + "00");
			var valChoPhepTre = (int)numPhutTre.Value;
			DAL.UpdateSetting((int)numPhutTre.Tag, valChoPhepTre.ToString());
			var valChoPhepSom = (int)numPhutSom.Value;
			DAL.UpdateSetting((int)numPhutSom.Tag, valChoPhepSom.ToString());
			var valLamThemAfterOT = (int)numPhutAfterOT.Value;
			DAL.UpdateSetting((int)numPhutAfterOT.Tag, valLamThemAfterOT.ToString());
