namespace ChamCong_v05.zMisc {
	partial class Form1 {
		...
		private void InitializeComponent() {
			...
			this.gridControl1.Size = new System.Drawing.Size(479, 275);
			...
			this.groupBox2.Location = new System.Drawing.Point(507, 363);
			...
			// groupBox3
			// 
			this.groupBox3.Controls.Add(this.timeEdit4);
			this.groupBox3.Controls.Add(this.timeEdit5);
			this.groupBox3.Controls.Add(this.checkBox4);
			this.groupBox3.Controls.Add(this.checkBox5);
			this.groupBox3.Font = new System.Drawing.Font("Tahoma", 9F, System.Drawing.FontStyle.Bold);
			this.groupBox3.Location = new System.Drawing.Point(507, 224);
			...
			this.groupBox4.Location = new System.Drawing.Point(507, 118);
			...
			this.checkBox1.Text = "Thêm giờ VÀO";
			...
			this.checkBox2.Size = new System.Drawing.Size(119, 18);
			this.checkBox2.TabIndex = 0;
			this.checkBox2.Text = "Thêm check RA";
			...
			this.checkBox3.Text = "Bỏ qua nếu đã có check vân tay cùng kiểu";
			this.checkBox3.UseVisualStyleBackColor = true;
			// 
			// timeEdit1
			// 
			this.timeEdit1.EditValue = new System.DateTime(2015, 4, 14, 0, 0, 0, 0);
			this.timeEdit1.Location = new System.Drawing.Point(139, 20);
			this.timeEdit1.Name = "timeEdit1";
			this.timeEdit1.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo),
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Search)});
			this.timeEdit1.Properties.EditFormat.FormatString = "%h\\:mm";
			...
			this.timeEdit1.Properties.Mask.EditMask = "\\d?\\d:\\d\\d";
			this.timeEdit1.Properties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.Regular;
			this.timeEdit1.Size = new System.Drawing.Size(123, 20);
			this.timeEdit1.TabIndex = 1;
			// 
			// timeEdit2
			// 
			this.timeEdit2.EditValue = new System.DateTime(2015, 4, 14, 0, 0, 0, 0);
			this.timeEdit2.Location = new System.Drawing.Point(985, 129);
			this.timeEdit2.Name = "timeEdit2";
			this.timeEdit2.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.timeEdit2.Size = new System.Drawing.Size(100, 20);
			this.timeEdit2.TabIndex = 0;
			// 
			// timeEdit3
			// 
			this.timeEdit3.EditValue = new System.DateTime(2015, 4, 14, 0, 0, 0, 0);
			this.timeEdit3.Location = new System.Drawing.Point(139, 46);
			this.timeEdit3.Name = "timeEdit3";
			this.timeEdit3.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo),
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Search)});
			this.timeEdit3.Properties.EditFormat.FormatString = "%h\\:mm";
			this.timeEdit3.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.Custom;
			this.timeEdit3.Properties.Mask.BeepOnError = true;
			this.timeEdit3.Properties.Mask.EditMask = "\\d?\\d:\\d\\d";
			this.timeEdit3.Properties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.Regular;
			this.timeEdit3.Size = new System.Drawing.Size(123, 20);
			this.timeEdit3.TabIndex = 1;
			// 
			// checkBox4
			// 
			...
			this.checkBox4.Text = "Thêm check VÀO";
			...
			this.checkBox5.Text = "Thêm check RA";
			this.checkBox5.UseVisualStyleBackColor = true;
			// 
			// timeEdit4
			// 
			this.timeEdit4.EditValue = new System.DateTime(2015, 4, 14, 0, 0, 0, 0);
			this.timeEdit4.Location = new System.Drawing.Point(139, 20);
			this.timeEdit4.Name = "timeEdit4";
			this.timeEdit4.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo),
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Search)});
			this.timeEdit4.Properties.EditFormat.FormatString = "%h\\:mm";
			this.timeEdit4.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.Custom;
			this.timeEdit4.Properties.Mask.BeepOnError = true;
			this.timeEdit4.Properties.Mask.EditMask = "\\d?\\d:\\d\\d";
			this.timeEdit4.Properties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.Regular;
			this.timeEdit4.Size = new System.Drawing.Size(123, 20);
			this.timeEdit4.TabIndex = 1;
			// 
			// timeEdit5
			// 
			this.timeEdit5.EditValue = new System.DateTime(2015, 4, 14, 0, 0, 0, 0);
			this.timeEdit5.Location = new System.Drawing.Point(139, 46);
			this.timeEdit5.Name = "timeEdit5";
			this.timeEdit5.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo),
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Search)});
			this.timeEdit5.Properties.EditFormat.FormatString = "%h\\:mm";
			this.timeEdit5.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.Custom;
			this.timeEdit5.Properties.Mask.BeepOnError = true;
			this.timeEdit5.Properties.Mask.EditMask = "\\d?\\d:\\d\\d";
			this.timeEdit5.Properties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.Regular;
			this.timeEdit5.Size = new System.Drawing.Size(123, 20);
			this.timeEdit5.TabIndex = 1;
			// 
			// Form1
			// 
