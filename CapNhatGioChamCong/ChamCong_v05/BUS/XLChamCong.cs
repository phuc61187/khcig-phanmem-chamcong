...
*/
		...
		public static void Tinh_TGLamViecTrongCa(DateTime tdBdLv, DateTime tdKtLvTrongCa, TimeSpan lunchMin, out TimeSpan tgGioLamViecTrongCa)
		{//ver 4.0.0.4	
			...
			while (x + 1 < ds_Check_A.Count)
			{
				...
				else
				{
					...
					else
					{
						...
						if (duration > XL2._22h00)
						{//ver 4.0.0.4	old:(duration > XL2._21h45)
	...
	out TimeSpan TGOLai, out TimeSpan TGLamThem, out bool QuaDem, out TimeSpan TGLamBanDem)
		...
		public static void TinhTG_LV_LVCa3_LamThem1Ca5(DateTime ThuocNgayCong, int HaveINOUT, Boolean DaXN,
			bool KoTruVaoTre, bool KoTruRaaSom,
			//bool VaotreTinhCV, bool RaaSomTinhCV, //ver 4.0.0.4	
			DateTime Vao, DateTime Raa,
			TimeSpan DutyOnn, TimeSpan DutyOff, TimeSpan chophepTreTS, TimeSpan chophepSomTS, TimeSpan batdaulamthemTS,
		...
		public static void TinhCong_1Ngay5(cNgayCong ngayCong, TimeSpan startNT, TimeSpan endddNT,
			...
			out structThoiGian TG, out PhuCap PhuCaps,out bool QuaDem)
		{
			TG = new structThoiGian();
			PhuCaps = new PhuCap();
			QuaDem = false;
			ngayCong.TrangThaiDiemDanh = TrangThaiDiemDanh.VANG_NGHI;
			// tính công của từng ThuocCa làm việc, sau đó tổng hợp Công làm việc của 1 ngày
			...
			foreach (var CIO in ngayCong.DSVaoRa)
			{
				...
				CIO.TG5 = new structThoiGian();
				TinhTG_LV_LVCa3_LamThem1Ca5(CIO.ThuocNgayCong, CIO.HaveINOUT, CIO.DaXN, CIO.DuyetChoPhepVaoTre, CIO.DuyetChoPhepRaSom,
					CIO.Vao.Time, CIO.Raa.Time, CIO.ThuocCa.Duty.Onn, CIO.ThuocCa.Duty.Off, CIO.ThuocCa.chophepTreTS, CIO.ThuocCa.chophepSomTS,
					CIO.ThuocCa.batdaulamthemTS, CIO.ThuocCa.LunchMin, new TimeSpan(0, CIO.OTMin, 0), startNT, endddNT,
					out CIO.TD5.BD_LV, out CIO.TD5.KT_LV, out CIO.TD5.KT_LV_ChuaOT, out CIO.TD5.BD_LV_Ca3, out CIO.TD5.KT_LV_Ca3,
					out CIO.TG5.GioThucTe5, out CIO.TG5.GioLamViec5, out CIO.TG5.VaoTre, out CIO.TG5.RaaSom,
					out CIO.TG5.GioLVTrongCa5,//ver 4.0.0.4	
					out CIO.TG5.OLai, out CIO.TG5.LamTangCuong, out CIO.QuaDem, out CIO.TG.LamBanDem);
		...
		public static void CongDonThoiGian_1NgayCong(ref structThoiGian ngayCong, ref structThoiGian CIO)
		{
			ngayCong.GioLamViec5 += CIO.GioLamViec5;
			//ngayCong.GioLVTrongCa5 += CIO.GioLVTrongCa5;
			ngayCong.GioThucTe5 += CIO.GioThucTe5;
			ngayCong.LamBanDem += CIO.LamBanDem;
			//ngayCong.LamTangCuong += CIO.LamTangCuong;
			//ngayCong.OLai += CIO.OLai;
			ngayCong.VaoTre += CIO.VaoTre;
			ngayCong.RaaSom += CIO.RaaSom;
			ngayCong.SoPhutLamThem5 += CIO.SoPhutLamThem5;
		}
