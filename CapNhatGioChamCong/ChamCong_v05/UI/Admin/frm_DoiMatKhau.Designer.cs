namespace ChamCong_v05.UI.Admin {
    partial class frm_DoiMatKhau {
        ...
        private void InitializeComponent() {
			...
			this.tbPass1.KeyDown += new System.Windows.Forms.KeyEventHandler(this.tbPass1_KeyDown);
			// 
			// tbPass2
			// 
			...
			this.tbPass2.KeyDown += new System.Windows.Forms.KeyEventHandler(this.tbPass1_KeyDown);
			// 
			// lbAccount
			// 
