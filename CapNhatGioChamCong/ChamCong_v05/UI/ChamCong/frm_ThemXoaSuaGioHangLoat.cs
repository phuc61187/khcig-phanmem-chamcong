	...
	public partial class frm_ThemXoaSuaGioHangLoat : Form {
		...
		private void loadRow(cUserInfo nhanvien_goc, cNgayCong ngayCong)
		{
			...
			foreach (var CIO in ngayCong.DSVaoRa) {
				...
				row["IsEdited"] = false; //row["IsEdited"] = CIO.IsEdited;
