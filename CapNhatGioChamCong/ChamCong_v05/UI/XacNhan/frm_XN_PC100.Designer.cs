namespace ChamCong_v05.UI.XacNhan {
	partial class frm_XN_PC100 {
		...
		private void InitializeComponent() {
			...
			this.radPCCus2.Size = new System.Drawing.Size(192, 19);
			this.radPCCus2.TabIndex = 5;
			this.radPCCus2.TabStop = true;
			this.radPCCus2.Text = "Tính PC tuỳ chỉnh cho giờ làm";
			this.toolTipHint.SetToolTip(this.radPCCus2, "Công 100% + PC tuỳ chỉnh cho toàn bộ giờ làm");
			...
			this.radPCCus1.Size = new System.Drawing.Size(259, 19);
			this.radPCCus1.TabIndex = 3;
			this.radPCCus1.TabStop = true;
			this.radPCCus1.Text = "Tính PC tuỳ chỉnh cho giờ làm trên 8 tiếng";
			this.toolTipHint.SetToolTip(this.radPCCus1, "Công 100% + PC tuỳ chỉnh tính riêng cho khoảng làm thêm giờ");
			...
			this.radPCNgayLe.Size = new System.Drawing.Size(340, 19);
			this.radPCNgayLe.TabIndex = 2;
			this.radPCNgayLe.TabStop = true;
			this.radPCNgayLe.Text = "Tính PC làm việc vào ngày lễ, tết {0}% (ngày), {1}% (đêm)";
			this.toolTipHint.SetToolTip(this.radPCNgayLe, "Công 100% + PC 200%");
			...
			this.radKhongPC.Size = new System.Drawing.Size(206, 19);
			...
			this.radPCNgayNghi.Size = new System.Drawing.Size(333, 19);
			this.radPCNgayNghi.TabIndex = 1;
			this.radPCNgayNghi.TabStop = true;
			this.radPCNgayNghi.Text = "Tính PC làm việc vào ngày nghỉ {0}% (ngày), {1}% (đêm)";
			this.toolTipHint.SetToolTip(this.radPCNgayNghi, "Công 100% + PC 100%");
			...
			this.Name = "frm_XN_PC100";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Xác nhận làm thêm";
			this.Load += new System.EventHandler(this.frm_XN_PC100_Load);
