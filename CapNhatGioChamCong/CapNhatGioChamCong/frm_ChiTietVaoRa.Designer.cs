namespace CapNhatGioChamCong {
    partial class frm_ChiTietVaoRa {
        ...
        private void InitializeComponent() {
			...
			this.btnDaoKieuChamCong.TabIndex = 0;
			...
			this.rdXoaVaoRa.Size = new System.Drawing.Size(197, 20);
			this.rdXoaVaoRa.TabIndex = 2;
			this.rdXoaVaoRa.Text = "Xóa giờ vào và giờ ra đã chọn";
			...
			this.rdXoaRa.Size = new System.Drawing.Size(135, 20);
			this.rdXoaRa.TabIndex = 1;
			this.rdXoaRa.Text = "Xóa giờ ra đã chọn";
			...
			this.rdXoaVao.Size = new System.Drawing.Size(143, 20);
			this.rdXoaVao.TabIndex = 0;
			this.rdXoaVao.TabStop = true;
			this.rdXoaVao.Text = "Xóa giờ vào đã chọn";
			...
			this.tabDaoGio.Location = new System.Drawing.Point(4, 22);
			this.tabDaoGio.Name = "tabDaoGio";
			this.tabDaoGio.Padding = new System.Windows.Forms.Padding(3);
			this.tabDaoGio.Size = new System.Drawing.Size(473, 544);
			...
			this.label2.Text = "Chọn chi tiết giờ vào ra để thực hiện.";
			// 
			// splitContainer1
			// 
